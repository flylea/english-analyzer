...
const VocabularyCard = ({ item, index }: VocabularyCardProps) => (
  <div
    className={cn(
  ...
  >
    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-linear-to-br from-sky-50/50 to-transparent pointer-events-none rounded-lg" />
