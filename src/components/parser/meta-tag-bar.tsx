...
export function MetaTagBar({ data }: MetaTagBarProps) {
  return (
    <motion.div
      ...
      {tagConfig.map((tag, i) => {
        ...
        return (
          <motion.div
            ...
            className="group flex items-center gap-2.5 px-4 py-2.5 bg-card rounded-lg border border-border hover:shadow-md transition-all duration-200 cursor-default"
          >
            <div
