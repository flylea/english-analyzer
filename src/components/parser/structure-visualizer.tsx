...
export function StructureVisualizer({ data }: StructureVisualizerProps) {
  return (
    <div className="space-y-8">
      {/* Core sentence diagram */}
      <div className="relative bg-slate-50/50 rounded-lg p-6 border border-slate-200">
        <div className="absolute -left-px top-0 bottom-0 w-1 bg-gradient-to-b from-sky-400 via-sky-500 to-sky-400 rounded-full" />
...
function ComponentBlock({ label, data, accent, labelBg }: ComponentBlockProps) {
  return (
    <div
